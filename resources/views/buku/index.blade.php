...
@section('content')
    ...
    <div class="container d-flex justify-content-center mt-3" style="min-height: 100vh;">
        <div class="w-100">
            ...
            {{-- Filter & search tetap bisa dipakai semua user --}}
            ...
            <table class="table table-striped table-bordered mx-auto">
                ...
                <tbody>
                    @if ($data_buku->isEmpty())
                        <tr>
                            <td colspan="{{ $isAdmin ? 6 : 5 }}" class="text-center text-danger">
                ...
                <div class="col-md-6">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-2"><strong>Total Harga Semua:</strong> Rp.
                                {{ number_format($total_harga, 2, ',', '.') }}</p>
                            <p class="mb-2"><strong>Harga Tertinggi:</strong> Rp.
                                {{ number_format($max_harga, 2, ',', '.') }}</p>
                            <p class="mb-0"><strong>Harga Terendah:</strong> Rp.
                                {{ number_format($min_harga, 2, ',', '.') }}</p>
                        </div>     
                    </div>
                </div>
            </div>
